...
const Downlode = () => {
  return (
    <>
      <Container>
        <section className="relative z-20 font-poopins bg-[url('/src/assets/downlode.jpg')] my-20 py-10 rounded-xl bg-cover bg-cente body-font">
          <div className="absolute top-0 opacity-20 z-20 bg-black w-full h-full rounded-xl"></div>

          <div className="flex flex-col items-center justify-center relative z-50">
          
             
            <h1 className="text-yellow-500 text-4xl mb-5 font-semibold">Downlode our app</h1>
