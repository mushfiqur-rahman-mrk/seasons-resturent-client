    ...
    <>
      <Container>
        <div className="my-10 relative">
          <img
            src="/src/assets/downlode app.jpg"
            className="rounded-xl shadow-lg"
            alt=""
          />
          <div className="absolute top-0 left-5">
            <div className="p-4 mt-20">
              <h2 className="text-3xl text-black font-extrabold my-3 text-center">
                Downlode our App
              </h2>
              <div className="flex w-full style-flex-col md:flex-row gap-y-4 gap-x-8 sm:items-center md:justify-center">
                <a
                  href=""
                  target="_blank"
                  className="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-red-200 rounded-2xl sm:rounded-2xl md:w-auto"
                  rel="noreferrer"
                >
                  <svg
                    className="w-7"
                ...
                <a
                  href=""
                  target="_blank"
                  className="flex items-center justify-center w-full px-5 py-3 text-center text-white bg-orange-300 rounded-2xl sm:rounded-2xl md:w-auto"
                  rel="noreferrer"
                >
                  <svg
                    className="w-7"
